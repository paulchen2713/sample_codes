# -*- coding: utf-8 -*-
"""
Created on Tue Oct 05 10:28:01 2022
...
def main():
    ...
    for annotation_type in ['sparse', 'dense', 'box']:
        ...
        signal_visualizer.save_multiple_annotations(path=f'/root/workspace/temp/rd_{annotation_type}.png', signal_type='range_doppler', color_scale=False, rotation=True, save_img=False, plot_img=True)
    ...
    for annotation_type in ['sparse', 'dense', 'box']:
        ...
        signal_visualizer.save_multiple_annotations(path=f'/root/workspace/temp/ra_{annotation_type}.png',
