...
# # config_path = D:\BeginnerPythonProjects\carrada_dataset\carrada_dataset\config.ini
# print(f"CARRADA_HOME = {CARRADA_HOME}")
# # CARRADA_HOME = D:\BeginnerPythonProjects\carrada_dataset\carrada_dataset

# config = Configurable(config_path).config
# print(f"config = {config}")
# # config = <configparser.ConfigParser object at 0x000001FAE1671B70>

# warehouse = config['data']['warehouse']
# print(f"warehouse = {warehouse}") # warehouse = /datasets/

# carrada = os.path.join(warehouse, 'Carrada')
# print(f"carrada = {carrada}") # carrada = /datasets/Carrada
